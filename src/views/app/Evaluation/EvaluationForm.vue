        ...
        <v-card>
            ...
            <v-card-text>
                <v-layout row wrap>
                    ...
                    <v-flex xs12>
                        <v-layout row wrap>
                            <span class="headline">Application Details</span>
                            <v-spacer></v-spacer>
                            <v-btn color="info" flat @click="show_overview = true">
                    ...
                    <v-flex xs12 pl-5>
                        <span v-if="checklist.length === 0"><i>No checklist</i></span>
            ...
            <v-divider></v-divider>
            <v-card-actions>
                <v-btn color="success" @click="decision(0)">Approve</v-btn>
                <v-spacer></v-spacer>
                <v-btn color="error" @click="decision(2)">Disapprove</v-btn>
                <v-spacer v-if="recommended_tasks.length > 0"></v-spacer>
                <v-btn color="info" v-if="recommended_tasks.length > 0" @click="show_recommend=true">Recommend</v-btn>
            </v-card-actions>
        </v-card>
        <v-dialog v-model="show_recommend" persistent transition="dialog-transition">
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-btn color="success" @click="decision(1)">Submit</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
        <v-dialog
            ...
            <v-card>
                ...
                <v-card-actions>
                    <v-btn color="error" flat @click="show_confirmation=false">Cancel</v-btn>
                    <v-spacer></v-spacer>
